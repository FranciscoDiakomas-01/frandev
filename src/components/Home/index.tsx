  ...
  return (
    ...
    >
      <div className="lg:w-[67%] w-[90%]  flex flex-col gap-2 items-center justify-center -mt-[70px]">
        <h1 className="lg:text-[55pt] sm:text-6xl md:text-[50pt]  text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-600 via-blue-500 to-white  animate__animated animate__backInUp lg:leading-[1.3] leading-[1.2]">
